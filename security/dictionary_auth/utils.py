...
async def my_to_oauth2_request(
    request: Request,
    ...
    post_args = dict(form)
    query_args = dict(request.query) # query_params
    print('post',post_args,'query',query_args)
...
async def my_to_fastapi_response(oauth2_response: OAuth2Response) -> Response:
