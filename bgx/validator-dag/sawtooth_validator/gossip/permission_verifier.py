...
class BatchListPermissionVerifier(Handler):
    ...
    def handle(self, connection_id, message_content):
        ...
        LOGGER.debug("BatchListPermissionVerifier:handle .. ")
        ...
        if not all(
                ...
                for batch in message_content.batches):
            return make_response(response_proto.INVALID_BATCH)
        LOGGER.debug("BatchListPermissionVerifier:handle PASS")
...
class NetworkPermissionHandler(Handler):
    ...
    def handle(self, connection_id, message_content):
        ...
        LOGGER.debug("NetworkPermissionHandler: permitted=%s",permitted)
        if not permitted:
