...
DB_URI = "uri://admin:foo@orientdb-test:2424/sw"
class OrientDatabaseTest(unittest.TestCase):
    ...
    def test_iteration_with_concurrent_mods(self):
        ...
        with db.cursor() as curs:
            ...
            print('test_iteration_with_concurrent_mods',list(iterator))
            """
            with self.assertRaises(StopIteration):
                val = next(iterator)
                print('test_iteration_with_concurrent_mods',val)
            """
    ...
    def test_hex_ordered_indexing(self):
        ...
        print("TEST_HEX_ORDERED_INDEXING",[to_hex(i) for i in range(1, entry_count)])
