...
class ConsensusState:
    ...
    def _compute_population_estimate(self, pbft_settings_view):
    ...
    def compute_local_mean(self, pbft_settings_view):
        ...
        if self._local_mean is None:
            ...
            if count < population_estimate_sample_size:
                ...
                target_wait_time = pbft_settings_view.target_wait_time
                initial_wait_time = pbft_settings_view.initial_wait_time
                self._local_mean = \
            ...
            # estimate of the validator network population size.
                ...
                self._local_mean = \
                    pbft_settings_view.target_wait_time * \
    ...
    def validator_is_claiming_too_frequently(self,
        ...
        expected_wins = 0
        block_count = 0
        minimum_win_count = pbft_settings_view.ztest_minimum_win_count
        maximum_win_deviation = pbft_settings_view.ztest_maximum_win_deviation
