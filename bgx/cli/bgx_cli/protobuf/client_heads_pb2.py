...
# source: bgx_cli/protobuf/client_heads.proto
...
ClientHeadsGetRequest = _reflection.GeneratedProtocolMessageType('ClientHeadsGetRequest', (_message.Message,), dict(
  ...
  __module__ = 'bgx_cli.protobuf.client_heads_pb2'
