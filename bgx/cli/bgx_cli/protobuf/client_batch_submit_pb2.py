...
# source: bgx_cli/protobuf/client_batch_submit.proto
...
_CLIENTBATCHSUBMITREQUEST.fields_by_name['batches'].message_type = bgx__cli_dot_protobuf_dot_batch__pb2._BATCH
...
ClientBatchStatus = _reflection.GeneratedProtocolMessageType('ClientBatchStatus', (_message.Message,), dict(
  ...
  InvalidTransaction = _reflection.GeneratedProtocolMessageType('InvalidTransaction', (_message.Message,), dict(
    ...
    __module__ = 'bgx_cli.protobuf.client_batch_submit_pb2'
