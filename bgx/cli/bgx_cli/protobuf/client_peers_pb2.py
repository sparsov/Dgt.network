...
# source: bgx_cli/protobuf/client_peers.proto
...
ClientPeersGetRequest = _reflection.GeneratedProtocolMessageType('ClientPeersGetRequest', (_message.Message,), dict(
  ...
  __module__ = 'bgx_cli.protobuf.client_peers_pb2'
