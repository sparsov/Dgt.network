...
# source: bgx_cli/protobuf/client_status.proto
...
ClientStatusGetRequest = _reflection.GeneratedProtocolMessageType('ClientStatusGetRequest', (_message.Message,), dict(
  ...
  __module__ = 'bgx_cli.protobuf.client_status_pb2'
