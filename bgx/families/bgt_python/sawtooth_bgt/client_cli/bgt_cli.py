...
from sawtooth_bgt.client_cli.generate import add_generate_parser
from sawtooth_bgt.client_cli.generate import do_generate
from sawtooth_bgt.client_cli.populate import add_populate_parser
from sawtooth_bgt.client_cli.populate import do_populate
from sawtooth_bgt.client_cli.create_batch import add_create_batch_parser
from sawtooth_bgt.client_cli.create_batch import do_create_batch
from sawtooth_bgt.client_cli.load import add_load_parser
from sawtooth_bgt.client_cli.load import do_load
from sawtooth_bgt.client_cli.bgt_workload import add_workload_parser
from sawtooth_bgt.client_cli.bgt_workload import do_workload
...
def main(prog_name=os.path.basename(sys.argv[0]), args=None):
    ...
    if args.command == 'set':
        ...
        raise BgtCliException("invalid command: {}".format(args.command))
...
def main_wrapper():
    ...
    try:
        main()
    except (BgtCliException, BgtClientException) as err:
