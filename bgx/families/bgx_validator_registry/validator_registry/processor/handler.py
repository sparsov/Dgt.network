...
from bgx_pbft_common.protobuf.bgx_validator_registry_pb2 import BgxValidatorMap
from bgx_pbft_common.protobuf.bgx_validator_registry_pb2 import BgxValidatorRegistryPayload

LOGGER = logging.getLogger(__name__)

STATE_TIMEOUT_SEC = 10
VAL_REG_NAMESPACE = hashlib.sha256("validator_registry".encode()).hexdigest()[0:6]
...
def _update_validator_state(context,
    ...
    # Protobuf doesn't offer delete item for BgxValidatorMap so create a new list
    ...
    # Add new state entries to BgxValidatorMap and BgxValidatorInfo
    ...
    LOGGER.info("Validator id %s was added to the validator_map and set.",validator_id)
