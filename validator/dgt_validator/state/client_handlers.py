...
from dgt_validator.state.batch_tracker import BatchFinishObserver
...
from dgt_validator.protobuf import client_batch_pb2
from dgt_validator.protobuf import client_block_pb2
from dgt_validator.protobuf import client_state_pb2
from dgt_validator.protobuf import client_transaction_pb2
from dgt_validator.protobuf import client_batch_submit_pb2
from dgt_validator.protobuf import client_list_control_pb2
from dgt_validator.protobuf.client_peers_pb2 import  ClientPeersGetRequest,ClientPeersGetResponse
from dgt_validator.protobuf.client_peers_pb2 import  ClientPeersControlRequest,ClientPeersControlResponse
           ...
           client_batch_submit_pb2.ClientBatchStatus.INVALID:
            ...
            for txn_info in invalid_txns:
                try:
                    ...
                    LOGGER.debug('_format_batch_statuses: error txn_info=%s',txn_info)
